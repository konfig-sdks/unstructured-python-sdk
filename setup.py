...
setup(
    name=NAME,
    version=VERSION,
    description="Unstructured Pipeline API",
    author="Konfig",
    author_email="engineering@konfigthis.com",
    url="https://github.com/konfig-sdks/unstructured-python-sdk/tree/main/python",
    keywords=["Konfig", "Unstructured Pipeline API"],
    python_requires=">=3.7",
